...
from agent_platform.sessions.backend import OpenSpec, SessionBackend
from agent_platform.sessions.backends.codex_app_server import CodexAppServerBackend
...
class ClaudeTmuxLlmBackend(SessionLlmBackend):
    def __init__(
        ...
        *,
        ...
        kind: str = "claude_cli",
        session_prefix: str = "agent-platform-llm",
        **kwargs: Any,
    ) -> None:
        backend = TmuxBackend(
            socket=socket,
